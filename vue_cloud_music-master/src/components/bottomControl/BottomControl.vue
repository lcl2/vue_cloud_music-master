    ...
    <div class="left">
      <div class="avatar" @click="$store.commit('changeMusicDetailCardState')">
        <img
          ...
          :draggable="false"
        />
        <img src="./images/logo.png" alt="" v-else :draggable="false" />
      </div>
      <div class="musicInfo">
...
export default {
  ...
  data() {
    return {
      ...
      //粤ICP备2021068014号<br>个人邮箱: 63012138@qq.com<br>
      recondInfo: `<div style='text-align:center;font-size:12px;'>本站为仿网易云音乐展示项目, 仅供学习, 侵权必删!</div>`,
      // 播放模式（顺序播放，随机播放）
      // order random
      playType: "order",
    };
